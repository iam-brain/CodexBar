        ...
        let payload = CostPayload(
            ...
            daily: [
                CostDailyEntryPayload(
                    ...
                    modelBreakdowns: [
                        CostModelBreakdownPayload(modelName: "gpt-5.3-codex-spark", costUSD: 0, totalTokens: 20),
                        CostModelBreakdownPayload(modelName: "gpt-5.2-codex", costUSD: 1.23, totalTokens: 135),
                    ]),
            ],
            totals: CostTotalsPayload(
